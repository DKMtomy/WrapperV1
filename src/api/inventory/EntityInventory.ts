...
import type { EntityInventoryComponent as IInventory, Container as IContainer, ItemStack } from '@minecraft/server';
...
export class EntityInventory {
    ...
    public swapItem(slot: number, otherSlot: number): void {
        return this._IContainer.swapItems(slot, otherSlot, this._IContainer);
    }
}
