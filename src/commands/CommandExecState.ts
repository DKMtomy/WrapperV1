...
import { CommandArgumentTypes, CommandEntry } from "../types/Commands";
...
export class CommandExecState {
    ...
    protected _buildArgs(): Record<string, any> | undefined {
        ...
        for (const key of Object.keys(schema)) {
            ...
            const optional = Array.isArray(schema[key])
                ? (schema[key] as [CommandArgumentTypes, boolean])[1] ?? false
                : false;
